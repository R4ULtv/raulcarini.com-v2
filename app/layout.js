          ...
          <footer className="border-t py-3 border-zinc-200 dark:border-zinc-800">
            <div className="max-w-3xl px-6 mx-auto flex items-center justify-between text-sm text-zinc-600 dark:text-zinc-400">
              <div className="flex gap-1.5">
                ...
                <Link href={"https://twitter.com/lil_poop__"} className="hover:scale-110 duration-150">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="currentColor"
                ...
                <Link href={"https://youtube.com/@lil-poop"} className="hover:scale-110 duration-150">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                    fill="currentColor"
                ...
                <Link href={"https://www.instagram.com/lil.poop__/"} className="hover:scale-110 duration-150">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                    fill="currentColor"
