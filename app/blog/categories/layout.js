...
export default function Layout({ children }) {
  ...
  return (
    <div>
      <div className="flex items-center justify-start gap-1.5 text-sm text-zinc-200 font-semibold mb-3">
        <Link
          href="/blog/categories"
          className={`md:px-2 p-0.5 flex items-center gap-1 text-sm font-semibold border-b-2 ${relativePath === "" ? "text-zinc-800 dark:text-zinc-200 border-zinc-300 dark:border-zinc-700" : "text-zinc-600 dark:text-zinc-400 border-transparent duration-75 transition ease-out hover:border-zinc-300 hover:dark:border-zinc-700"}`}
        >
