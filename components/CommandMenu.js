  ...
  return (
    <>
      ...
      <Command.Dialog
        ...
        overlayClassName="fixed inset-0 bg-zinc-900/50 ease-out data-[closed]:opacity-0 duration-300"
        contentClassName="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 max-w-xl w-full rounded-lg overflow-y-auto bg-zinc-100/95 dark:bg-zinc-900/95 backdrop-blur-xl ring-zinc-200 dark:ring-zinc-800 ring-2 shadow-2xl shadow-zinc-900/50 outline-none"
      >
        <Command.Input
